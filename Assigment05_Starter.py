...
# David Grunloh ,5.07.2021,Added code to complete step 3 and step 4
# David Grunloh, 5.08.2021,Added code to complete step 6 and step 7
# David Grunloh, 5.10.2021,Added and debugged code to complete step 5
# ------------------------------------------------------------------------ #
...
while (True):
    ...
    # Step 7 - Exit program
        ...
        # TODO: Add Code Here1
        input("Your session has ended. Press Enter to close.")
        break  # and Exit the program

    # Step 8 - Invalid Option
    else:
